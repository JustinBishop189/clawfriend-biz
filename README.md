...
**Web Presentation (Gemini Canvas):** _[Add your presentation link here after creating it]_
...
| `ai-showcase/` | Screenshots / links of AI prompts used for research |
| `data/` | Numbers, charts, research data (with sources) |

---

*Cook Your MVP competition — Research & Sales planning round.*
