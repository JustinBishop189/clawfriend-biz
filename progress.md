...
- [ ] [Data](./data/): numbers, charts, exports — each with source (URL, date)
...
- [ ] All deliverable files pushed to GitHub before presentation
...
- [ ] All numbers verified from primary sources (not “from AI” only)
